    ...
    dcc.Tabs(id='tabs', value='visualization_tab', children=[
        dcc.Tab(label='Visualization', value='visualization_tab', children=[
            ...
            dcc.Dropdown(
                ...
                value=['US', 'India', 'France', 'Germany','Italy'],
                multi=True
            ),
        ...
        dcc.Tab(label='SIR model', value='SIR_tab', children=[
            dcc.Markdown('''
            ## Select Country for SIR model
            '''),
            ...
            dcc.Graph(figure=fig2, id='SIR_plot')
        ])
    ])
])
